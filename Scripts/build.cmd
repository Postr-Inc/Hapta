...
bun build --compile --sourcemap=inline --minify --target=bun-linux-arm64 src/index.ts --outfile ./builds/linux-arm64/hapta-server 
bun build --compile --sourcemap=inline --minify --target=bun-darwin-x64 src/index.ts --outfile ./builds/darwin/arm64/hapta-server
bun build --compile --sourcemap=inline --minify --target=bun-linux-x64 src/index.ts --outfile ./builds/linux-x64/hapta-server
